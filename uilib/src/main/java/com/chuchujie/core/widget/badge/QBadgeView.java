...
public class QBadgeView extends View implements BadgeExtend {
    ...
    private void init() {
        ...
        mBadgeTextSize = PxUtils.dp2px(getContext(), 11);
        mBadgePadding = PxUtils.dp2px(getContext(), 5);
        mBadgeNumber = 0;
        mBadgeGravity = Gravity.END | Gravity.TOP;
        mGravityOffsetX = PxUtils.dp2px(getContext(), 1);
        mGravityOffsetY = PxUtils.dp2px(getContext(), 1);
        mFinalDragDistance = PxUtils.dp2px(getContext(), 90);
        mShowShadow = true;
    ...
    @Override
    public BadgeExtend bindTarget(final View targetView) {
        if (targetView == null) {
        ...
        switch (event.getActionMasked()) {
            ...
            case MotionEvent.ACTION_POINTER_DOWN:
                ...
                if (mDraggable && event.getPointerId(event.getActionIndex()) == 0
                    ...
                    mDefalutRadius = PxUtils.dp2px(getContext(), 7);
    ...
    protected Bitmap createBadgeBitmap() {
        Bitmap bitmap = Bitmap.createBitmap((int) mBadgeBackgroundRect.width() + PxUtils.dp2px(getContext(), 3),
                (int) mBadgeBackgroundRect.height() + PxUtils.dp2px(getContext(), 3), Bitmap.Config.ARGB_8888);
    ...
    private void showShadowImpl(boolean showShadow) {
        int x = PxUtils.dp2px(getContext(), 1);
        int y = PxUtils.dp2px(getContext(), 1.5f);
        switch (mDragQuadrant) {
            case 1:
                x = PxUtils.dp2px(getContext(), 1);
                y = PxUtils.dp2px(getContext(), -1.5f);
                break;
            case 2:
                x = PxUtils.dp2px(getContext(), -1);
                y = PxUtils.dp2px(getContext(), -1.5f);
        ...
        mBadgeBackgroundPaint.setShadowLayer(showShadow ? PxUtils.dp2px(getContext(), 2f)
                : 0, x, y, 0x33000000);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (mBadgeText != null) {
            ...
            if (mDraggable && mDragging) {
                ...
                if (mDragOutOfRange = startCircleRadius < PxUtils.dp2px(getContext(), 1.5f)) {
     ...
     */
    @Override
    public BadgeExtend setBadgeNumber(int badgeNumber) {
    ...
    @Override
    public BadgeExtend setBadgeText(String badgeText) {
    ...
    @Override
    public BadgeExtend setExactMode(boolean isExact) {
        mExact = isExact;
        if (mBadgeNumber > 99) {
    ...
    @Override
    public BadgeExtend setShowShadow(boolean showShadow) {
    ...
    @Override
    public BadgeExtend setBadgeBackgroundColor(int color) {
    ...
    @Override
    public BadgeExtend stroke(int color, float width, boolean isDpValue) {
        mColorBackgroundBorder = color;
        mBackgroundBorderWidth = isDpValue ? PxUtils.dp2px(getContext(), width) : width;
        invalidate();
        return this;
    }
    ...
    @Override
    public BadgeExtend setBadgeBackground(Drawable drawable) {
        return setBadgeBackground(drawable, false);
    }

    @Override
    public BadgeExtend setBadgeBackground(Drawable drawable, boolean clip) {
    ...
    @Override
    public BadgeExtend setBadgeTextColor(int color) {
    ...
    @Override
    public BadgeExtend setBadgeTextSize(float size, boolean isSpValue) {
        mBadgeTextSize = isSpValue ? PxUtils.dp2px(getContext(), size) : size;
        measureText();
        invalidate();
        return this;
    }
    ...
    public float getBadgeTextSize(boolean isSpValue) {
        return isSpValue ? PxUtils.px2dp(getContext(), mBadgeTextSize) : mBadgeTextSize;
    }

    @Override
    public BadgeExtend setBadgePadding(float padding, boolean isDpValue) {
        mBadgePadding = isDpValue ? PxUtils.dp2px(getContext(), padding) : padding;
        createClipLayer();
        invalidate();
        return this;
    }
    ...
    public float getBadgePadding(boolean isDpValue) {
        return isDpValue ? PxUtils.px2dp(getContext(), mBadgePadding) : mBadgePadding;
    }
     ...
     */
    @Override
    public BadgeExtend setBadgeGravity(int gravity) {
    ...
    @Override
    public BadgeExtend setGravityOffset(float offset, boolean isDpValue) {
        return setGravityOffset(offset, offset, isDpValue);
    }

    @Override
    public BadgeExtend setGravityOffset(float offsetX, float offsetY, boolean isDpValue) {
        mGravityOffsetX = isDpValue ? PxUtils.dp2px(getContext(), offsetX) : offsetX;
        mGravityOffsetY = isDpValue ? PxUtils.dp2px(getContext(), offsetY) : offsetY;
        invalidate();
        return this;
    }
    ...
    public float getGravityOffsetX(boolean isDpValue) {
        return isDpValue ? PxUtils.px2dp(getContext(), mGravityOffsetX) : mGravityOffsetX;
    }

    @Override
    public float getGravityOffsetY(boolean isDpValue) {
        return isDpValue ? PxUtils.px2dp(getContext(), mGravityOffsetY) : mGravityOffsetY;
    }
    ...
    @Override
    public BadgeExtend setOnDragStateChangedListener(OnDragStateChangedListener l) {
        mDraggable = l != null;
